...
foreach ($models as $model) {
    ...
    <tr>
        ...
        <td><a href="javascript:void(0)" class="delete" onclick="fun(<?php echo $model['id']; ?>);">删除</a>   <a href='index.php?r=index/update&id=<?php echo $model['id']; ?>' class="update">修改</a></td>
    </tr>
        <?php
}
?>
...
<script type="text/javascript">
    $(document).ready(function(){
        $(".submit").on("click",function(){
            location.href="index.php?r=index/add";
        })
    })
    function fun(id){
